...
public class Kurosaki extends Character{
    Random random = new Random();
    public Kurosaki(boolean isPlayer) {
        // Generate the random skill values first
        super("Kurosaki", 100, 25, isPlayer, 0, 0, 0, 10, 20, 50, 100);  // Default values for skills and mana
