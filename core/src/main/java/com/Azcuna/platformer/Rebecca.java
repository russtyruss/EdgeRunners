...
public class Rebecca extends Character{
    Random random = new Random();
    public Rebecca(boolean isPlayer) {
        // Generate the random skill values first
        super("Rebecca", 100, 25, isPlayer, 0, 0, 0, 10, 20, 50, 100);  // Default values for skills and mana
