...
public class Faraday extends Character{
    Random random = new Random();
    public Faraday(boolean isPlayer) {
        // Generate the random skill values first
        super("Faraday", 100, 25, isPlayer, 0, 0, 0, 10, 20, 50, 100);  // Default values for skills and mana
